...
sendresults.addEventListener("click", () => {
  if(debt.value !=0 & stocksquantity.value !=0 & stock.value !=0 & ropliq.value !=0 & nopat.value != 0 & capex.value != 0 & varncg.value != 0 & depreciation.value != 0){
...
//   let ropliq_1 = parseInt(rplq * (1 + (capex.value/rplq)))
  // let ropliq_2 = parseInt(ropliq_1 * (1 + capex.value/rplq))
  // let ropliq_3 = parseInt(ropliq_2 * (1 + capex.value/rplq))
  // let ropliq_perpet = parseInt(ropliq_3 * (1 + 0.01))
...
//   let nopat_1 = parseInt(nopatv * (1 + (capex.value/rplq)))
//   let nopat_2 = parseInt(nopat_1 * (1 + (capex.value/rplq)))
//   let nopat_3 = parseInt(nopat_2 * (1 + (capex.value/rplq)))
//   let nopat_perpet = parseInt(nopat_3 * (1 + 0.01))
...
//   let capex_1 = parseInt(cpxv * (1 +(cpxv/rplq)))
//   let capex_2 = parseInt(capex_1 * (1 +(cpxv/rplq)))
//   let capex_3 = parseInt(capex_2 * (1 +(cpxv/rplq)))
//   let capex_perpet = parseInt(capex_3 * (1 + 0.01))
...
//   let vrncg_1 = parseInt(vrncgv * (1 + cpxv/rplq))
//   let vrncg_2 = parseInt(vrncg_1 * (1 + cpxv/rplq))
//   let vrncg_3 = parseInt(vrncg_2 * (1 + cpxv/rplq))
//   let vrncg_perpet = parseInt(vrncg_3 * (1 + 0.01))
...
//   let deprec_1 = parseInt(deprecV * (1 + cpxv/rplq))
//   let deprec_2 = parseInt(deprec_1 * (1 + cpxv/rplq))
//   let deprec_3 = parseInt(deprec_2 * (1 + cpxv/rplq))
//   let deprec_perpet = parseInt(deprec_3 * (1 + 0.01))
...
function calcs(){
  ...
  let capex_1 = parseInt(cpxv * (1 + (nopatv/rplq)))
  // let capex_2 = parseInt(capex_1 * (1 + nopatv/rplq))
  // let capex_3 = parseInt(capex_2 * (1 + nopatv/rplq))
  // let capex_perpet = parseInt(capex_3 * (1 + 0.01))
  ...
  let ropliq_1 = parseInt(rplq * (1 + (nopatv/rplq)))
  // let ropliq_2 = parseInt(ropliq_1 * (1 + nopatv/rplq))
  // let ropliq_3 = parseInt(ropliq_2 * (1 + nopatv/rplq))
  // let ropliq_perpet = parseInt(ropliq_3 * (1 + 0.01))
  ...
  let nopat_1 = parseInt(nopatv * (1 + (nopatv/rplq)))
  // let nopat_2 = parseInt(nopat_1 * (1 + nopatv/rplq))
  // let nopat_3 = parseInt(nopat_2 * (1 + nopatv/rplq))
  // let nopat_perpet = parseInt(nopat_3 * (1 + 0.01))
// 
  let nopat_result_1 = document.getElementById("NOPAT-1")
  // let nopat_result_2 = document.getElementById("NOPAT-2")
  ...
  let vrncg_1 = parseInt(vrncgv * (1 + (nopatv/rplq)))
  // let vrncg_2 = parseInt(vrncg_1 * (1 + nopatv/rplq))
  // let vrncg_3 = parseInt(vrncg_2 * (1 + nopatv/rplq))
  // let vrncg_perpet = parseInt(vrncg_3 * (1 + 0.01))
// 
  let vrncg_result_1 = document.getElementById("VAR-NCG-1")
  // let vrncg_result_2 = document.getElementById("VAR-NCG-2")
  ...
  let deprec_1 = parseInt(deprecV * (1 + (nopatv/rplq)))
  // let deprec_2 = parseInt(deprec_1 * (1 + nopatv/rplq))
  // let deprec_3 = parseInt(deprec_2 * (1 + nopatv/rplq))
  // let deprec_perpet = parseInt(deprec_3 * (1 + 0.01))
// 
  let deprec_result_1 = document.getElementById("Depreciation-1")
  // let deprec_result_2 = document.getElementById("Depreciation-2")
  ...
  // deprec_result_4.innerHTML = parseInt(deprec_perpet)
  //
  let fcfirma_ano1 = (nopat_1 - capex_1 - vrncg_1 + deprec_1)
  // let fcfirma_ano2 = (nopat_2 - capex_2 - vrncg_2 + deprec_2)
  // let fcfirma_ano3 = (nopat_3 - capex_3 - vrncg_3 + deprec_3)
  // let fcfirma_perpet = (nopat_perpet - capex_perpet - vrncg_perpet + deprec_perpet)
  ...
  // let fcfirma_present2 = (fcfirma_ano2/(1+0.1)^2)
  // let fcfirma_present3 = (fcfirma_ano3/(1+0.1)^3)
  // let fcfirma_present_perpet = (fcfirma_perpet/(1+0.01)^3)
  // let fcd_da_firma = (fcfirma_present1 + fcfirma_present2 + fcfirma_present3 + fcfirma_present_perpet)
// 
  // let fcfirma_present_result_1 = document.getElementById("presente-value-1")
  // let fcfirma_present_result_2 = document.getElementById("presente-value-2")
  ...
  fcfirma_present_result_1.innerHTML = parseInt(fcfirma_present1)
  // fcfirma_present_result_2.innerHTML = parseInt(fcfirma_present2)
  // fcfirma_present_result_3.innerHTML = parseInt(fcfirma_present3)
  // fcfirma_present_result_4.innerHTML = parseInt(fcfirma_present_perpet)
  //
  // let valordafirma = fcd_da_firma
  // let acionistavalue = (valordafirma - (debt.value/1000))
  // let fairprice = (acionistavalue/stocksquantity.value)
  // let upside = ((fairprice - stockvalue)-1)

  // let valordafirma_result = document.getElementById("Valor-firma")
  // let acionistavalue_result = document.getElementById("investor-value")
  // let market_value_result = document.getElementById("market-value")
  // let stockprice = document.getElementById("valor")
  // let fairprice_result = document.getElementById("fairprice")
  // let upside_result = document.getElementById("upside-value")

  // valordafirma_result.innerHTML = parseInt(valordafirma)
  // acionistavalue_result.innerHTML = parseInt(acionistavalue)
  // market_value_result.innerHTML = parseInt(acionistavalue)
  // stockprice.innerHTML = parseInt(stock.value)
  // fairprice_result.innerHTML = parseInt(fairprice)
  // upside_result.innerHTML = parseInt(upside)
  
  console.log(acionistavalue)
