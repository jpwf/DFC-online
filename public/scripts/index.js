...
function ropliqcalc() {
  ...
  let ropliq_1 = parseInt(rplq * (1 + 0.01))
  let ropliq_2 = parseInt(ropliq_1 * (1 + 0.01))
  let ropliq_3 = parseInt(ropliq_2 * (1 + 0.01))
...
function nopatcalc() {
  ...
  let nopat_1 = parseInt(nopatv * (1 + 0.01))
  let nopat_2 = parseInt(nopat_1 * (1 + 0.01))
  let nopat_3 = parseInt(nopat_2 * (1 + 0.01))
...
function capexcalc() {
  ...
  let capex_1 = parseInt(cpxv * (1 + 0.01))
  let capex_2 = parseInt(capex_1 * (1 + 0.01))
  let capex_3 = parseInt(capex_2 * (1 + 0.01))
...
function varncgcalc() {
  ...
  let vrncg_1 = parseInt(vrncgv * (1 + 0.01))
  let vrncg_2 = parseInt(vrncg_1 * (1 + 0.01))
  let vrncg_3 = parseInt(vrncg_2 * (1 + 0.01))
...
function deprecalc() {
  ...
  let deprec_1 = parseInt(deprecV * (1 + 0.01))
  let deprec_2 = parseInt(deprec_1 * (1 + 0.01))
  let deprec_3 = parseInt(deprec_2 * (1 + 0.01))
...
function present(){
  let fcfirma_present1 = fcfirma_ano1/(1+0.01)^1
  let fcfirma_present2 = fcfirma_ano2/(1+0.01)^2
  let fcfirma_present3 = fcfirma_ano3/(1+0.01)^3
...
function calcs(){
  ...
  let upside = ((fairprice - stock.value)-1)
